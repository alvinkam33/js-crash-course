...
console.log("Hello, my name is " + string + " and I am presenting a workshop at " + time)

console.log(`Hello, my name is ${string} and I am presenting a workshop at ${time}`)

console.log("Hello, my name is ".concat(string).concat(" and I am presenting a workshop at ").concat(time))
